...
def show_predict_page():
    ...
    distance_SY = st.slider("Distance to San Ysidro border (in kilometers)", 5.0, 25.0, step = 2.5)
    distance_OT = st.slider("Distance to Otay border (in kilometers)", 5.0, 25.0, step = 2.5)

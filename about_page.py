...
def show_about_page():
    ...
    st.write("* An Artificial Neural Network was implemented, however in didn't gave a better performance than previous models. As I'm currently studying TensorFlow and Deep Learning, in the future we could retry this ANN approach by hypertuning the parameters and getting better results.")
    ...
    st.write("You can see the full required to do this app in its [GitHub repo.](https://github.com/IvanVC21/Tijuana-House-Prices)")